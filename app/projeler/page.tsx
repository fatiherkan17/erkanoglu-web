...
export default function ProjectsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f4f2ed] text-[#151515]">
      <header className="sticky top-0 z-40 border-b border-black/10 bg-[#f4f2ed]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-5 lg:px-10">
          ...
          <nav className="hidden items-center gap-6 text-[11px] uppercase tracking-[0.16em] text-black/55 md:flex">
            <Link href="#referans-projeler" className="hover:text-black">Referans Projeler</Link>
            <Link href="#uygulama-projeleri" className="hover:text-black">Uygulama Projeleri</Link>
            <Link href="#imalat-arsivi" className="hover:text-black">İmalat Arşivi</Link>
          </nav>
      ...
      <section id="referans-projeler" className="border-y border-black/10 bg-[#181818] text-white scroll-mt-24">
      ...
      <section id="uygulama-projeleri" className="scroll-mt-24 bg-[#dedbd3]">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
      ...
      <section id="imalat-arsivi" className="scroll-mt-24 border-y border-black/10">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
