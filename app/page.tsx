...
export default function HomePage() {
  return (
    <main className="bg-[#f4f2ed] text-[#151515]">
      <header className="fixed left-0 right-0 top-0 z-50">
        <div className="flex items-center justify-between px-6 py-6 lg:px-10">
          ...
          <nav className="hidden items-center gap-7 text-sm text-white mix-blend-difference md:flex">
            ...
            <Link href="/projeler">Referans Projeler</Link>
      ...
      <section className="bg-[#dedbd3]"><div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32"><div className="flex flex-col justify-between gap-10 md:flex-row md:items-end"><div><span className="text-xs uppercase tracking-[0.3em] text-black/40">Yaptıklarımız</span><h2 className="mt-6 text-4xl font-medium tracking-[-0.045em] md:text-6xl">Sadece sonuçları değil,<br />işin kendisini de gösteriyoruz.</h2></div><p className="max-w-md text-black/55">Gerçek referans projelerimizi; proje kapsamı ve saha fotoğraflarıyla birlikte zaman içinde arşivliyoruz.</p></div><div className="mt-16 grid gap-4 md:grid-cols-1"><Link href="/projeler" className="group bg-[#f4f2ed] p-8 transition hover:-translate-y-1"><span className="text-xs uppercase tracking-[0.25em] text-black/35">Referans Projeler</span><h3 className="mt-16 text-3xl font-medium tracking-[-0.04em]">Tamamlanan işler →</h3><p className="mt-4 text-sm leading-7 text-black/50">Gerçek projelerimizi, proje fotoğraflarını ve inşai faaliyet aşamalarını inceleyin.</p></Link></div></div></section>

      <section className="border-y border-black/10 bg-[#181818] text-white"><div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32"><div className="grid gap-6 md:grid-cols-2"><Link href="/projeler" className="border border-white/15 p-8 transition hover:bg-white hover:text-black"><span className="text-xs uppercase tracking-[0.25em] text-white/40">Referans İşler</span><h2 className="mt-12 text-3xl font-medium">Projeleri inceleyin. →</h2></Link><Link href="/is-birligi" className="border border-white/15 p-8 transition hover:bg-white hover:text-black"><span className="text-xs uppercase tracking-[0.25em] text-white/40">Çözüm Ortakları</span><h2 className="mt-12 text-3xl font-medium">İhtiyaca göre ekibi büyütüyoruz. →</h2></Link></div></div></section>
