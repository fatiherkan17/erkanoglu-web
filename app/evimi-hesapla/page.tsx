...
export default function EvimiHesaplaPage() {
  ...
  const calculation = useMemo(() => {
    ...
    const selectedQuality =
      qualities.find((item) => item.value === form.quality) ??
      qualities[1];
      ...
      <section className="mx-auto max-w-7xl px-6 pb-12 pt-20 lg:px-10 lg:pb-16 lg:pt-28">
        <div className="max-w-4xl">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-8 text-black/55">
            Birkaç temel bilgi girerek projenizin ilk aşamadaki yaklaşık
            maliyet aralığını görün. Bu hesaplama yalnızca ön fizibilite
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-black/15 bg-[#faf9f6] px-5 py-5 pr-16 text-lg outline-none transition focus:border-black"
                  />

                  <span className="absolute right-5 top-1/2 -translate-y-1/2 text-sm text-black/40">
                    m²
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full appearance-none border border-black/15 bg-[#faf9f6] px-5 py-5 outline-none focus:border-black"
                >
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {qualities.map((quality) => (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        updateField("quality", quality.value)
                      }
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-black/15 bg-[#faf9f6] px-5 py-5 outline-none focus:border-black"
                />
              </div>
              ...
              <button
                type="button"
                onClick={calculate}
                disabled={!form.propertyType || !form.area}
                className="w-full bg-black px-6 py-5 text-sm font-medium text-white transition hover:bg-black/85 disabled:cursor-not-allowed disabled:bg-black/20"
              >
          ...
          <div className="flex min-h-[560px] flex-col justify-between bg-[#171717] p-7 text-white md:p-10 lg:p-14">
            <div>
              ...
              {!showResult || !calculation ? (
                <div className="mt-24">
                  <div className="text-7xl font-light tracking-[-0.06em] text-white/20">
                    ₺
                  </div>

                  <h2 className="mt-8 max-w-md text-3xl font-medium leading-tight">
                    Yapı bilgilerinizi girin.
                  </h2>

                  <p className="mt-5 max-w-md leading-7 text-white/45">
                    Hesaplama tamamlandığında burada yaklaşık maliyet
                    aralığınızı göreceksiniz.
                  </p>
                </div>
              ) : (
                <div className="mt-20">
                  <p className="text-sm text-white/45">
                    Tahmini yapı maliyeti
                  </p>
                  ...
                  <div className="mt-8 grid gap-5 text-sm">
                    <div className="flex justify-between gap-4">
                      <span className="text-white/40">Yapı tipi</span>
                    ...
                    <div className="flex justify-between gap-4">
                      <span className="text-white/40">Kat</span>
            ...
            {showResult && calculation && (
              <div className="mt-16 border-t border-white/10 pt-8">
                <p className="max-w-md text-sm leading-6 text-white/45">
                  Bu değer ön fizibilite amaçlı yaklaşık bir aralıktır.
                  Arsa, zemin, proje, ruhsat, yapı sistemi, bölgesel
                  koşullar ve seçilecek malzemeler gerçek maliyeti
                  değiştirebilir.
                </p>

                <Link
                  href="/admin/project-requests"
                  className="mt-7 inline-flex rounded-full bg-white px-7 py-4 text-sm font-medium text-black"
                >
                  Projem İçin Ön Görüşme İstiyorum →
                </Link>
              </div>
            )}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <h3 className="mt-4 text-xl font-medium">
                Tasarımı teknik olarak çözelim.
              </h3>
            </div>
            ...
            <div>
              ...
              <h3 className="mt-4 text-xl font-medium">
                Projeyi ruhsat sürecine taşıyalım.
              </h3>
            </div>
          </div>
        </div>
